...
export const navigationLabels: Record<ViewKey, { short: string; stageAware: string }> = {
  ...
  'consumer-profile': { short: 'Consumer Profile', stageAware: 'Consumer login · review posted jobs, bids, and hiring decisions' },
  'contractor-profile': { short: 'Contractor Profile', stageAware: 'Contractor login · review bids sent, replies, and active opportunities' },
  'vendor-dashboard': { short: 'Workspace', stageAware: 'Legacy customer workspace · track requests, incoming bids, and selected contractors' },
