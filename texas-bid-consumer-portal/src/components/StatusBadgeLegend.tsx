  ...
  return (
    <div className="panel status-legend-panel">
      <div className="panel-header">
        <div>
          <div className="eyebrow">Status guide</div>
          <div className="panel-title">{title}</div>
        </div>
        <span className="status status-open">{items.length} states</span>
      </div>
      <div className="status-legend-list">
        {items.map((item) => (
          <div className="status-legend-item draft-card" key={item.label}>
