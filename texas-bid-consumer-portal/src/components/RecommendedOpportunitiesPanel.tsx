...
export function RecommendedOpportunitiesPanel({
  ...
  return (
    <div className="panel recommended-opportunities-panel-shell">
      <div className="panel-header">
        <div>
          <div className="eyebrow">Recommended bids</div>
          <div className="panel-title">{title}</div>
        </div>
        <span className="status status-open">{opportunities.length} picks</span>
      </div>
